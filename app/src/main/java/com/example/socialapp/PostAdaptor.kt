...
class PostAdaptor(options:FirestoreRecyclerOptions<Post>,val listener:IPostAdapter):FirestoreRecyclerAdapter<Post,PostAdaptor.PostViewHolder>(options) {
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int, model: Post) {
        ...
        holder.userText.text = model.createdBy.display
